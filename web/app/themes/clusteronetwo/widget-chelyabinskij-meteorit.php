<div id="curiosity-block">
	...
	<div class="head"><h1><strong>Метеорит над Челябинском<br /></strong>Анализ, свидетельства, фото </h1><div class="split"></div></div>


	<?php query_posts('tag=chelyabinskij-meteorit&showposts=4'); ?>
