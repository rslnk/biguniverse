...
<div id="container">
	...
	<section id="content">
		...
		<div id="posts-block" class="column-4x compact listview">	
			...
			<?php else: // Если результат поиска ничего не дал - показать вот эту часть: ?>
		
				<br />
				
				<div class="title">По запросу <strong>&laquo;<?php the_search_query(); ?>&raquo;</strong> ничего не найдено. 
				<br />
				<br />

				<span class="title">Ничего страшного!</span>
				<br />
				<br />
				<p>Общеизвестно, что черные дыры тоже еще не были найдены, но ведь это не значит, что их не существует!</p>
		...
		</div> <!-- end of post-block div -->

	</section>	

	<aside id="sidebar"><?php get_sidebar(); ?></aside>
