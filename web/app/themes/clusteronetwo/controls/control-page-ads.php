...
function ads_options() {
   add_theme_page('Ads options', 'Реклама', 'manage_options', 'ads_options', 'ads_options_page');
}

add_action('admin_menu', 'ads_options', 1);
...
if(isset($_POST['update_ads_options']) && $_POST['update_ads_options'] == 'abx' ) {
